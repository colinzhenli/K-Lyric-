...
#语料路径
train_csv = '/aliyun-06/share_v2/yangshiping/projects/lyric_generation/ChineseLyrics/train.txt.csv'
valid_csv = '/aliyun-06/share_v2/yangshiping/projects/lyric_generation/ChineseLyrics/valid.txt.csv'
test_csv = '/aliyun-06/share_v2/yangshiping/projects/lyric_generation/ChineseLyrics/test.txt.csv'
...
def main(args):
    tokenizer.add_special_tokens({'additional_special_tokens':["<a>","<b>","<c>"]})  #添加自定义token
    print(tokenizer.additional_special_tokens_ids) # 查看此类特殊token有哪些
